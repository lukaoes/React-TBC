...
import SingleProdRemoveModal from "./singleProdRemoveModal";

interface IProd {
  product: Product;
}

const SingleProdRemoveButton: FC<IProd> = ({ product }) => {
    ...
    <div>
      {isEditModalOpen && (
        <>
          ...
          ></div>
          <SingleProdRemoveModal product={product} onClose={handleCloseModal} />
        </>
      )}
      <button
...
export default SingleProdRemoveButton;
